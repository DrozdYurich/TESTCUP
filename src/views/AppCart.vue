...
const sentRegions = ref([]);
const showPlane = ref(false);
const planeStyle = ref({});
const planeDirection = ref(1); // 1 — вправо, -1 — влево
const planeAngle = ref(0); // угол в градусах
const inputValue = ref(10); // Значение из input, по умолчанию 10
const regionCodes = ref({ from: "", to: "" }); // Здесь будут коды регионов
...
const regions = [
  { num: 1, title: "Республика Адыгея" },
  { num: 2, title: "Республика Башкортостан" },
  { num: 3, title: "Республика Бурятия" },
  { num: 4, title: "Республика Алтай" },
  { num: 5, title: "Республика Дагестан" },
  { num: 6, title: "Республика Ингушетия" },
  { num: 7, title: "Кабардино-Балкарская Республика" },
  { num: 8, title: "Калмыкия" },
  { num: 9, title: "Карачаево-Черкесская Республика" },
  { num: 10, title: "Республика Карелия" },
  { num: 11, title: "Республика Коми" },
  { num: 12, title: "Республика Марий Эл" },
  { num: 13, title: "Республика Мордовия" },
  { num: 14, title: "Республика Саха (Якутия)" },
  { num: 15, title: "Республика Северная Осетия-Алания" },
  { num: 16, title: "Республика Татарстан" },
  { num: 17, title: "Республика Тыва" },
  { num: 18, title: "Удмуртская Республика" },
  { num: 19, title: "Республика Хакасия" },
  { num: 20, title: "Чеченская Республика" },
  { num: 21, title: "Чувашская Республика" },
  { num: 22, title: "Алтайский край" },
  { num: 23, title: "Забайкальский край" },
  { num: 24, title: "Камчатский край" },
  { num: 25, title: "Краснодарский край" },
  { num: 26, title: "Красноярский край" },
  { num: 27, title: "Пермский край" },
  { num: 28, title: "Приморский край" },
  { num: 29, title: "Ставропольский край" },
  { num: 30, title: "Хабаровский край" },
  { num: 31, title: "Амурская область" },
  { num: 32, title: "Архангельская область" },
  { num: 33, title: "Астраханская область" },
  { num: 34, title: "Белгородская область" },
  { num: 35, title: "Брянская область" },
  { num: 36, title: "Владимирская область" },
  { num: 37, title: "Волгоградская область" },
  { num: 38, title: "Вологодская область" },
  { num: 39, title: "Воронежская область" },
  { num: 40, title: "Ивановская область" },
  { num: 41, title: "Иркутская область" },
  { num: 42, title: "Калининградская область" },
  { num: 43, title: "Калужская область" },
  { num: 44, title: "Кемеровская область" },
  { num: 45, title: "Кировская область" },
  { num: 46, title: "Костромская область" },
  { num: 47, title: "Курганская область" },
  { num: 48, title: "Курская область" },
  { num: 49, title: "Ленинградская область" },
  { num: 50, title: "Липецкая область" },
  { num: 51, title: "Магаданская область" },
  { num: 52, title: "Московская область" },
  { num: 53, title: "Мурманская область" },
  { num: 54, title: "Нижегородская область" },
  { num: 55, title: "Новгородская область" },
  { num: 56, title: "Новосибирская область" },
  { num: 57, title: "Омская область" },
  { num: 58, title: "Оренбургская область" },
  { num: 59, title: "Орловская область" },
  { num: 60, title: "Пензенская область" },
  { num: 61, title: "Псковская область" },
  { num: 62, title: "Ростовская область" },
  { num: 63, title: "Рязанская область" },
  { num: 64, title: "Самарская область" },
  { num: 65, title: "Саратовская область" },
  { num: 66, title: "Сахалинская область" },
  { num: 67, title: "Свердловская область" },
  { num: 68, title: "Смоленская область" },
  { num: 69, title: "Тамбовская область" },
  { num: 70, title: "Тверская область" },
  { num: 71, title: "Томская область" },
  { num: 72, title: "Тульская область" },
  { num: 73, title: "Тюменская область" },
  { num: 74, title: "Ульяновская область" },
  { num: 75, title: "Челябинская область" },
  { num: 76, title: "Ярославская область" },
  { num: 77, title: "Москва" },
  { num: 78, title: "Санкт-Петербург" },
  { num: 79, title: "Севастополь" },
  { num: 80, title: "Еврейская автономная область" },
  { num: 81, title: "Ненецкий АО" },
  { num: 82, title: "Ханты-Мансийский АО - Югра" },
  { num: 83, title: "Чукотский АО" },
  { num: 84, title: "Ямало-Ненецкий АО" },
  { num: 85, title: "Республика Крым" },
  { num: 86, title: "Калужская область" },
  { num: 87, title: "Курская область" },
  { num: 88, title: "Орловская область" },
  { num: 89, title: "Псковская область" },
];
...
function getRegionNumByTitle(title) {
...
async function sendRegions() {
  if (Coins.value >= inputValue.value) {
    ...
    if (selectedRegions.value.length === 2) {
      regionCodes.value = {
        from: selectedRegions.value[0],
        to: selectedRegions.value[1],
      };
      sentRegions.value = [...selectedRegions.value];

      // --- Вот эти строки вставьте ---
      const title1 = getTitleByCode(regionCodes.value.from);
      const title2 = getTitleByCode(regionCodes.value.to);

      DataTitle.value.num1 = title1;
      DataTitle.value.num2 = title2;
      Data.value.num1 = getRegionNumByTitle(title1);
      Data.value.num2 = getRegionNumByTitle(title2);
...
function getAngleBetweenPoints(x1, y1, x2, y2) {
  ...
  // Если ваша иконка смотрит вправо, этого достаточно.
  // Если вверх — добавьте +90 градусов.
  return degrees;
}

function updateRegionStyles() {
  // Обновляем подсветку регионов через класс
  document.querySelectorAll(".rf-map [data-code]").forEach((el) => {
...
async function animatePlane() {
  ...
  const [from, to] = sentRegions.value;
  const elFrom = document.querySelector(`[data-code="${from}"]`);
  const elTo = document.querySelector(`[data-code="${to}"]`);
  const mapRect = document.querySelector(".rf-map").getBoundingClientRect();

  if (!elFrom || !elTo || !mapRect) return;

  const fromRect = elFrom.getBoundingClientRect();
  const toRect = elTo.getBoundingClientRect();

  const fromCenter = {
    left: fromRect.left + fromRect.width / 2 - mapRect.left,
    top: fromRect.top + fromRect.height / 2 - mapRect.top,
  };
  const toCenter = {
    left: toRect.left + toRect.width / 2 - mapRect.left,
    top: toRect.top + toRect.height / 2 - mapRect.top,
  };

  planeAngle.value = getAngleBetweenPoints(
    fromCenter.left,
    fromCenter.top,
    toCenter.left,
    toCenter.top
  ...
  planeStyle.value = {
    left: `${fromCenter.left}px`,
    top: `${fromCenter.top}px`,
    transition: "none",
  };
...
function regionClickHandler(e) {
  // Делегируем: ищем ближайший path с data-code
  let el = e.target.closest("[data-code]");
  if (!el) return;
  const code = el.getAttribute("data-code");
  if (!code) return;
...
onMounted(async () => {
  ...
  // Подсветка после hot reload
  updateRegionStyles();
});

onBeforeUnmount(() => {
  const svg = document.querySelector(".rf-map svg");
  if (svg) svg.removeEventListener("click", regionClickHandler);
});
</script>
...
<template>
  <div>
    ...
    <div class="container flex justify-between">
      <div class="selection-info" v-if="DataTitle.num1">
        <div class="info-card">
          <div class="route-details">
            <div class="route-point">
              <span class="point-label">Правильные комбинации</span>
              <span class="point-value">{{ dataCount[0] }}</span>
              <span class="point-value">{{ dataCount[1] }}</span>
            </div>
            <div class="route-point">
              <span class="point-label">Откуда</span>
              <span class="point-value">{{ DataTitle.num1 }}</span>
              <span class="region-code">{{ Data.num1 }}</span>
            </div>

            <div class="route-point">
              <span class="point-label">Куда</span>
              <span class="point-value">{{ DataTitle.num2 }}</span>
              <span class="region-code">{{ Data.num2 }}</span>
            </div>
          </div>
        </div>
      </div>
...
.selection-info {
  margin-top: 2rem;
  font-family: "Segoe UI", system-ui, sans-serif; /* Единый шрифт для инфо-блока */
}
