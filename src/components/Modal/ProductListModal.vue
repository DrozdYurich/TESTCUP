<template>
  <div class="p-4">
    ...
    <p>
      <strong class="text-xl">Как играть:</strong> С начала выберете начало
      вашего пароля. Далее вы можете выбирать любую точку в радиусе 1.
      Разрешается выбирать уже использованные точки, но нельязя использовать уже
      пройденный маршрут. Всего вы должны выбрать 6 точек или 5 линий. Удачи!
    </p>
